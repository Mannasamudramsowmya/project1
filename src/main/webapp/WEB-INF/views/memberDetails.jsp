...
<div class="container">
        <div class="form-group">
            <label class="col-md-7 control-label" for="billingStreet">Street Name</label>
             <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="col-md-7 control-label" for="billingPlotNumber">Plot Number</label>
             <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="col-md-7 control-label" for="billingCity">City</label>
             <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="col-md-7 control-label" for="billingState">State</label>
             <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="col-md-7 control-label" for="billingCountry">Country</label>
             <div class="col-md-7">
